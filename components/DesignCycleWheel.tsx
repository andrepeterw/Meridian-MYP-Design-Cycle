    ...
    <div className="relative">
      ...
      >
        ...
        <g style={{ filter: active === "A" ? "brightness(1.08)" : undefined, transition: "filter 0.15s" }}>
          <path d="M 300 122 A 178 178 0 0 1 478 300 L 430 300 A 130 130 0 0 0 300 170 Z" fill="#0E477F" stroke="var(--paper)" strokeWidth={3} />
          <text x={408.89} y={191.11} textAnchor="middle" dominantBaseline="central" fontSize={30} fontWeight={700} fill="white">A</text>
          <path d="M 300 50 A 250 250 0 0 1 395.67 69.03 L 368.12 135.55 A 178 178 0 0 0 300 122 Z" fill="#E9EFF5" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 395.67 69.03 A 250 250 0 0 1 476.78 123.22 L 425.87 174.13 A 178 178 0 0 0 368.12 135.55 Z" fill="#E9EFF5" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 476.78 123.22 A 250 250 0 0 1 530.97 204.33 L 464.45 231.88 A 178 178 0 0 0 425.87 174.13 Z" fill="#E9EFF5" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 530.97 204.33 A 250 250 0 0 1 550 300 L 478 300 A 178 178 0 0 0 464.45 231.88 Z" fill="#E9EFF5" stroke="var(--paper)" strokeWidth={2.5} />
        ...
        <g style={{ filter: active === "B" ? "brightness(1.08)" : undefined, transition: "filter 0.15s" }}>
          <path d="M 478 300 A 178 178 0 0 1 300 478 L 300 430 A 130 130 0 0 0 430 300 Z" fill="#DE8513" stroke="var(--paper)" strokeWidth={3} />
          <text x={408.89} y={408.89} textAnchor="middle" dominantBaseline="central" fontSize={30} fontWeight={700} fill="white">B</text>
          <path d="M 550 300 A 250 250 0 0 1 530.97 395.67 L 464.45 368.12 A 178 178 0 0 0 478 300 Z" fill="#FCF0DE" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 530.97 395.67 A 250 250 0 0 1 476.78 476.78 L 425.87 425.87 A 178 178 0 0 0 464.45 368.12 Z" fill="#FCF0DE" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 476.78 476.78 A 250 250 0 0 1 395.67 530.97 L 368.12 464.45 A 178 178 0 0 0 425.87 425.87 Z" fill="#FCF0DE" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 395.67 530.97 A 250 250 0 0 1 300 550 L 300 478 A 178 178 0 0 0 368.12 464.45 Z" fill="#FCF0DE" stroke="var(--paper)" strokeWidth={2.5} />
        ...
        <g style={{ filter: active === "C" ? "brightness(1.08)" : undefined, transition: "filter 0.15s" }}>
          <path d="M 300 478 A 178 178 0 0 1 122 300 L 170 300 A 130 130 0 0 0 300 430 Z" fill="#0D7D65" stroke="var(--paper)" strokeWidth={3} />
          <text x={191.11} y={408.89} textAnchor="middle" dominantBaseline="central" fontSize={30} fontWeight={700} fill="white">C</text>
          <path d="M 300 550 A 250 250 0 0 1 204.33 530.97 L 231.88 464.45 A 178 178 0 0 0 300 478 Z" fill="#E7F3F0" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 204.33 530.97 A 250 250 0 0 1 123.22 476.78 L 174.13 425.87 A 178 178 0 0 0 231.88 464.45 Z" fill="#E7F3F0" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 123.22 476.78 A 250 250 0 0 1 69.03 395.67 L 135.55 368.12 A 178 178 0 0 0 174.13 425.87 Z" fill="#E7F3F0" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 69.03 395.67 A 250 250 0 0 1 50 300 L 122 300 A 178 178 0 0 0 135.55 368.12 Z" fill="#E7F3F0" stroke="var(--paper)" strokeWidth={2.5} />
        ...
        <g style={{ filter: active === "D" ? "brightness(1.08)" : undefined, transition: "filter 0.15s" }}>
          <path d="M 122 300 A 178 178 0 0 1 300 122 L 300 170 A 130 130 0 0 0 170 300 Z" fill="#CC4C2D" stroke="var(--paper)" strokeWidth={3} />
          <text x={191.11} y={191.11} textAnchor="middle" dominantBaseline="central" fontSize={30} fontWeight={700} fill="white">D</text>
          <path d="M 50 300 A 250 250 0 0 1 69.03 204.33 L 135.55 231.88 A 178 178 0 0 0 122 300 Z" fill="#FBEEEB" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 69.03 204.33 A 250 250 0 0 1 123.22 123.22 L 174.13 174.13 A 178 178 0 0 0 135.55 231.88 Z" fill="#FBEEEB" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 123.22 123.22 A 250 250 0 0 1 204.33 69.03 L 231.88 135.55 A 178 178 0 0 0 174.13 174.13 Z" fill="#FBEEEB" stroke="var(--paper)" strokeWidth={2.5} />
          ...
          <path d="M 204.33 69.03 A 250 250 0 0 1 300 50 L 300 122 A 178 178 0 0 0 231.88 135.55 Z" fill="#FBEEEB" stroke="var(--paper)" strokeWidth={2.5} />
