      ...
      strands: [
        {
          ...
          citation: {
            ...
            counterpoint:
              "Kirschner, Sweller, and Clark (2006) push back on this kind of inquiry first approach directly, arguing that minimally guided tasks often teach less efficiently than direct instruction. Decide for yourself whether this brief's open ended approach is helping you or slowing you down.",
    ...
    B: {
      ...
      strands: [
        ...
        },
        {
          ...
          rubricSummary:
            "Excellent work {{justifies}} the selection fully and critically, addressing the specification in detail and getting ahead of the strongest possible objection.",
          citation: {
            refId: "meyer2024",
            framing:
