export const homeContent = {
  ...
  faq: [
    {
      question: "Do I have to finish it in one sitting?",
      answer:
        "No. The route is meant to be revisited across a whole unit, not completed in one session.",
    },
    {
      question: "What if my project doesn't fit the order exactly?",
      answer:
        "That's normal. The Design Cycle is iterative. Work through the strands in order the first time, then go back to an earlier one whenever your project needs it.",
    },
    {
      question: "Where do I actually write my answers?",
      answer:
        "In your own Process Journal. This site doesn't save anything you type. It's purely navigational. See the Process Journal guide for how to set one up.",
    },
    {
      question: "What if I'm not sure which grade page to use?",
      answer:
        "Use the page that matches your current grade level. If you're between units or unsure, ask your Design teacher which page fits your current project.",
    },
  ],
  credits: {
