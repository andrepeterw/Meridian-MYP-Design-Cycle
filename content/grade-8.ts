      ...
      strands: [
        ...
        },
        {
          ...
          citation: {
            refId: "meyerrosegordon2014",
            framing:
              "The same UDL framework (Meyer, Rose, & Gordon, 2014) treats adjusting a plan mid-process as evidence of active, responsive thinking rather than a failure to plan correctly. Explaining those changes well is itself a skill the framework values.",
          },
